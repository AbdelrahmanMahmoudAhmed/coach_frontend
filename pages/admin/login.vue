<template>
  <div
    class="app-container h-[100vh] p-[40px] lg:pt-[110px] lg:pb-[120px] dark:bg-[unset]"
  >
    <div class="h-full flex items-center pb-20">
      <div class="w-full">
          ...
          <div class="panel-input-holder ">
            <div class="relative">
              <img
                ...
                } absolute z-3 top-[17px] w-[18px] h-[18px]`"
                src="../../assets/imgs/auth/email.png"
                alt=""
              />
              <img
                v-else
                ...
                src="../../assets/imgs/auth/emailDisable.png"
                alt=""
              />
              <input
                @blur="() => disabledIconFun('email')"
                @focus="() => focusedIconFun('email')"
                v-model="state.email"
          ...
          <div class="panel-input-holder ">
            <div class="relative">
              <img
                ...
                src="../../assets/imgs/auth/locked.svg"
                alt=""
              />
              <img
                v-else
                ...
                src="../../assets/imgs/auth/lockedDisabled.svg"
                alt=""
              />
              <div
              ...
              <input
                @blur="() => disabledIconFun('password')"
                @focus="() => focusedIconFun('password')"
        ...
        <div class="pt-[20px] lg:pt-[30px]">
          ...
          >
            <NuxtLink class="[word-spacing:6px]" to="/">
              {{ $t("global.to_home") }}</NuxtLink
            >
          </span>
        </div>
      </div>
